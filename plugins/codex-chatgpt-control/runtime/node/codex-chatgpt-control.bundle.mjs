...
async function sleepWithinDeadline(_page, deadline, requestedMs) {
  ...
  if (waitMs2 <= 0) return;
  await new Promise((resolve4) => setTimeout(resolve4, waitMs2));
}
...
async function waitMs(page, ms2) {
  await (page.waitForTimeout?.(ms2) ?? new Promise((resolve4) => setTimeout(resolve4, ms2)));
}
