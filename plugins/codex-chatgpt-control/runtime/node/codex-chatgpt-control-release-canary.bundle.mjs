...
async function readConfigurationPanel(page) {
  ...
  return page.evaluate((axisLabels) => {
    ...
    const openerCandidates = scopedOpenerCandidates.length > 0 ? scopedOpenerCandidates : openerCandidatesFrom(main2 === null ? [] : [main2]);
    const result = {
      axisRows,
...
async function clickFileChooserTarget(page, selector, paths, timeoutMs, options = {}) {
  ...
  if (await locatorCount2(locator) !== 1) {
